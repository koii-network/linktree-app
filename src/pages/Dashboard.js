import { 
  ...
  function ControlPanel() {
    ...
    <>
      ...
      <Box height={"60vh"} width={"50vw"} bgGradient="linear(to-r, teal.500,green.500)" p={5} borderRadius='15px'>
        <Flex>
          <Avatar size="md" name="User Avatar" />
          <Spacer />
          <Heading color='white' fontSize='2xl'>Control Panel</Heading>
        </Flex>
        
        <Text color='white' marginTop='10px' fontSize='15px' textAlign='center'>
        🎏 yourusername 🎏
